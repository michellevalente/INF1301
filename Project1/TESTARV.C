...
#define		COSTURAR_FOLHAS_CMD	"=costfol"
#define		IMPRIMIR_FOLHAS_CMD	"=impfol"

/*****  Declarações de variáveis  *****/

	  ptArvore VetArvore[NUM_ARVORES];
	        /* Vetor contendo os ponteiros para as árvores */
	  int VetCostura[NUM_ARVORES] = {0,0,0,0,0};
	        /* Vetor que diz se a árvore foi costurada ou não (booleano) */
   ...
   TST_tpCondRet TST_EfetuarComando( char * ComandoTeste )
   {
      ...
      /* Testar ARV Criar árvore */
         ...
         if ( strcmp( ComandoTeste , CRIAR_ARV_CMD ) == 0 )
         {
            ...
            NumLidos = LER_LerParametros( "ii" ,
                               &NumArvore , &CondRetEsperada ) ;
            if ( NumLidos != 2 )
            {
               return TST_CondRetParm ;
            } /* if */

			VetCostura[NumArvore] = 0 ;

            CondRetObtido = ARV_CriarArvore( &VetArvore[NumArvore] ) ;
      ...
      /* Testar ARV Adicionar filho à direita */
         ...
         else if ( strcmp( ComandoTeste , INS_DIR_CMD ) == 0 )
         {
            ...
            NumLidos = LER_LerParametros( "ici" ,
                              &NumArvore , &ValorDado , &CondRetEsperada ) ;
            if ( NumLidos != 3 )
            {
               return TST_CondRetParm ;
            } /* if */
            ...
            CondRetObtido = ARV_InserirDireita( &VetArvore[NumArvore] , ValorDado ) ;
      ...
      /* Testar ARV Adicionar filho à esquerda */
         ...
         else if ( strcmp( ComandoTeste , INS_ESQ_CMD ) == 0 )
         {
			...
			CondRetObtido = ARV_InserirEsquerda( &VetArvore[NumArvore] , ValorDado ) ;
      ...
      /* Testar ARV Ir para nó pai */
         ...
         else if ( strcmp( ComandoTeste , IR_PAI_CMD ) == 0 )
         {
            ...
            CondRetObtido = ARV_IrPai( &VetArvore[NumArvore] ) ;
      ...
      /* Testar ARV Ir para nó à esquerda */
         ...
         else if ( strcmp( ComandoTeste , IR_ESQ_CMD ) == 0 )
         {
            ...
            CondRetObtido = ARV_IrNoEsquerda( &VetArvore[NumArvore] ) ;
      ...
      /* Testar ARV Ir para nó à direita */
         ...
         else if ( strcmp( ComandoTeste , IR_DIR_CMD ) == 0 )
         {
            ...
            CondRetObtido = ARV_IrNoDireita( &VetArvore[NumArvore] ) ;
      ...
      /* Testar ARV Obter valor corrente */
         ...
         else if ( strcmp( ComandoTeste , OBTER_VAL_CMD ) == 0 )
         {
            ...
            NumLidos = LER_LerParametros( "ici" ,
                               &NumArvore , &ValorEsperado , &CondRetEsperada ) ;
            if ( NumLidos != 3 )
            {
               return TST_CondRetParm ;
            } /* if */

            CondRetObtido = ARV_ObterValorCorr( &VetArvore[NumArvore] , &ValorObtido ) ;
      ...
      /* Testar ARV Destruir árvore */
         ...
         else if ( strcmp( ComandoTeste , DESTROI_CMD ) == 0 )
         {
            ...
            ARV_DestruirArvore( &VetArvore[NumArvore] ) ;
      ...
      /* Testar ARV Costurar árvore */
		 ...
		 else if ( strcmp( ComandoTeste , COSTURAR_FOLHAS_CMD ) == 0 )
         {
            NumLidos = LER_LerParametros( "ii" ,
                               &NumArvore , &CondRetEsperada ) ;
			...
			VetCostura[NumArvore] = 1 ;

			CondRetObtido = ARV_CosturarNosFolha( &VetArvore[NumArvore] ) ;
      ...
      /* Testar ARV Imprimir Costura */
		 ...
		 else if ( strcmp( ComandoTeste , IMPRIMIR_FOLHAS_CMD ) == 0 )
         {
            NumLidos = LER_LerParametros( "ii" ,
                               &NumArvore, &CondRetEsperada ) ;
			...
			CondRetObtido = ARV_ImprimirNosFolha( &VetArvore[NumArvore] ) ;

			if ( CondRetObtido != 5 && CondRetObtido != 4 )
			{
			   if ( VetCostura[NumArvore] == 0 )
			   {
				   CondRetObtido = ARV_CondRetSemCostura ;
			   } /* if */
			} /* if */

            return TST_CompararInt( CondRetEsperada , CondRetObtido ,
                                    "Retorno errado ao imprimir costura da árvore." ) ;
