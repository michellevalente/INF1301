...
*	  =altvalor						inxLista  string  CondRetEsp	
*
***************************************************************************/
...
static const char ALT_VALOR_CMD			  [ ] = "=altvalor"		  ;
...
***********************************************************************/
   ...
   TST_tpCondRet TST_EfetuarComando( char * ComandoTeste )
   {
      ...
      /* LIS  &Alterar valor */
         ...
         else if ( strcmp( ComandoTeste , ALT_VALOR_CMD ) == 0 )
         {
            ...
            return TST_CompararInt( CondRetEsp ,
                      LIS_AlterarValor( vtListas[ inxLista ] , StringDado ) ,
                      "Condicao de retorno errada ao alterar valor" ) ;
